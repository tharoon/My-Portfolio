  ...
  <body style = "background-image:url({{ asset('images/homepage_background.jpg') }}); background-size: cover;
  ...
  <div class = "wrapper">
    <div class ="sidebar">
     <h2><img src = "{{ asset('images/logo.jpg') }}" alt = "logo" style="width:150px;height:150px"></h2>
     <h4>Tharoon T Thiagarajan</h4>
     <ul>
      <li><a href = "#">HOME</a></li>
      <li><a href = "#" onclick="return loginPop();">ABOUT</a></li>
      <li><a href = "#" onclick="return loginPop();">SKILLS</a></li>
      <li><a href = "#" onclick="return loginPop();">RESUMES</a></li>
      <li><a href = "#" onclick="return loginPop();">PORTFOLIO</a></li>
      <li><a href = "#" onclick="return loginPop();">BLOG</a></li>
      <li><a href = "#" onclick="return loginPop();">REFERENCES</a></li>
      <li><a href = "#" onclick="return loginPop();">HIRE ME</a></li>
      <li><a href = "#" onclick="return loginPop();">CONTACT</a></li>
...
<div id="myForm" class="modal">
  ...
  @endif
  <form class="modal-content" name = "signUp" action="{{url('/signUp')}}" method = "POST">
    {{csrf_field()}}
   ...
   <div id="myForm1" class="loginmodal">
    <form class="loginmodal-content" action="{{url('/login')}}" method="get">
