...
<body>
	<div class="headBox">
		<hr>
		<p class = "hireMeheaderBox">Resume Update Designation</p> 
		<hr>
	</div>

<table style="height: 70%;">
		<form name = "contactMe" action = "<?php echo e(url('updateDesignation')); ?>" method="post">
...
<?php /**PATH C:\xampp\htdocs\Laravel\Thiagarajan_Portfolio\resources\views/pages/resumeUpdateDesignation.blade.php ENDPATH**/ ?>