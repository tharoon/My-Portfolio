...
<table style="height: 70%;">
	<form name = "contactMe" action = "<?php echo e(url('updateSkills')); ?>" method="post">
...
<?php /**PATH C:\xampp\htdocs\Laravel\Thiagarajan_Portfolio\resources\views/pages/skillsUpdate.blade.php ENDPATH**/ ?>