...
<div id="myForm" class="modal">
  ...
  <?php endif; ?>
  <form class="modal-content" name = "signUp" action="<?php echo e(url('/signUp')); ?>" method = "POST">
   ...
   <div id="myForm1" class="loginmodal">
    <form class="loginmodal-content" action="<?php echo e(url('/login')); ?>" method="get">
...
</html><?php /**PATH C:\xampp\htdocs\Laravel\Thiagarajan_Portfolio\resources\views/pages/index.blade.php ENDPATH**/ ?>